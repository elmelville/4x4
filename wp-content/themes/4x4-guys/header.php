...
<div id="masthead" class="header">
	...
	<div class="header-info">
		...
		<div class="header-cart">
			...
			?>
			<div class="headicon-label">Cart</div>
		</div>
		<?php endif; ?>
		...
		<div class="header-personal">
			...
			<a class="header-gopersonal" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><br><div class="headicon-label">Account</div></a>
			<ul>
			...
			<?php else : ?>
			<a class="header-gopersonal" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><div class="headicon-label">Account</div></a>
			<ul>
				<li>
		...
		<?php if (!empty($motor_options['compare']['id']) && $motor_options['header_compare'] !== 'hide' && defined( 'WCCM_VERISON' )) : ?>
		<a title="<?php esc_html_e('Compare', 'motor'); ?>" href="<?php echo esc_url($motor_options['compare']['url']); ?>" class="header-compare"><?php if (!empty($motor_options['compare']['count'])) : ?><span id="h-compare-count"><?php echo intval($motor_options['compare']['count']); ?></span><?php endif; ?><div class="headicon-label">Compare</div></a>
		<?php endif; ?>

		<a title="<?php esc_html_e('Wishlist', 'motor'); ?>" href="<?php echo esc_url($motor_options['wishlist']['url']); ?>" class="header-favorites"><?php $wishlist_count = YITH_WCWL()->count_products(); if (!empty($wishlist_count)) : ?><span id="h-wishlist-count"><?php echo intval($wishlist_count); ?></span><br><?php endif; ?><div class="headicon-label">Wishlist</div></a>
	...
	<div class="nav-search">
		<input type="search" class="cm_SearchBox-input" name="s" placeholder="Search for products..." autocomplete="off" data-cm-role="search-input">
		<button type="submit" class="dgwt-wcas-search-submit"><i class="fa fa-search" aria-hidden="true"></i></button>
	</div>
