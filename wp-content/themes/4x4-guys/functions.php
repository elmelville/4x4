...
function orbisius_ct_4x4_guys_child_theme_enqueue_styles() {
		$parent_style = 'orbisius_ct_4x4_guys_parent_style';
		$parent_base_dir = 'motor';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_4x4_guys_child_theme_enqueue_styles' );
