...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="prod-li-info<?php if ((empty($sku) && $catalog_listinfo == 'sku') || ($catalog_listinfo == 'hide')) echo ' no-sku'; ?><?php if (!comments_open()) echo ' no-rating'; ?>">
	...
	<?php motor_product_badge($post->ID, 'prod-li-badge'); ?>
