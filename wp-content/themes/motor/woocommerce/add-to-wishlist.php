...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id); ?> prod-li-favorites<?php echo ( $exists && ! $available_multi_wishlist ) ? ' wishlist-added' : '' ?>">
