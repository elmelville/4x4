        ...
        <div class="section-list-withsb"<?php if ($catalog_sidebar == 'sticky') echo ' id="section-list-withsb"'; ?>>
            <div class="theiaStickySidebar">
                ...
                <div class="section-top">
                    <?php /*<a data-hidetext="<?php esc_html_e('Close', 'motor'); ?>" data-showtext="<?php esc_html_e('Catalog', 'motor'); ?>" href="#" class="section-menu-btn" id="section-menu-btn"><?php echo esc_html__('Catalog', 'motor')?></a>*/ ?>
                    <?php /*
