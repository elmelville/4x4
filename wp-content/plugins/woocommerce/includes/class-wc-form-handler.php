...
class WC_Form_Handler {
	...
	public static function save_address() {
		...
		foreach($addresses as $address_type){

			$load_address = isset( $wp->query_vars['edit-address'] ) ? wc_edit_address_i18n( sanitize_title( $wp->query_vars['edit-address'] ), true ) : $address_type;
